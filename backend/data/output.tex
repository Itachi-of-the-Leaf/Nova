...
\begin{abstract}
This study investigates how advanced learners utilize mobile technology as part of their engagement strategies for enhancing language acquisition goals and personal learning styles within an English-language context. Employing a mixed-methods approach, we collected data from twenty students via semi-structured interviews to analyze the intersection between learner agency, device usage, and educational outcomes. Our findings suggest that learners recognize mobile devices as beneficial tools for accessing language resources tailored to individual needs (e.g., vocabulary lists or grammar exer095). Notably, while a segment of students demonstrates an intention-driven approach by strategically selecting and employing device features conducive to their learning objectives, another group adopts more impulsive interactions with technology in the classroom setting. These observations underscore the importance of understanding learners' personalized engagement patterns when incorporating mobile devices into language education practices for foreign students.
\end{abstract}
