...
\begin{abstract}
Abstract: This study investigated advanced learners' utilization of mobile technology for self-directed language acquisition within an educational setting. Data were gathered from twenty students via semi-structured interviews, and analyzed using both qualitative and quantitative methods. Findings indicate that while some participants exhibited a heightened awareness regarding the positive impact of mobile devices on their learning processes, noting enhanced access to resources tailored to individual preferences and styles—a reflection of learner-centered approaches in language education—others demonstrated less structured engagement with these technologies during classroom activities. These results underscore a partial reliance on technology for autonomous learning while revealing opportunities for more strategic device integration into formal educational practices to optimize mobile learning outcomes among advanced English learners.
